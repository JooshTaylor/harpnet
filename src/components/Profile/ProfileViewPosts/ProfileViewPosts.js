...
class ProfileViewPosts extends Component {
  render() {
            ...
            <div className="profile-post__details">
              <div className="profile-post__details-img-box">
                <img
                  ...
                  className="profile-post__details-img"
              ...
              <div className="profile-post__details-text-box">
                <h2
                  onClick={this.handleViewProfile}
                  name={post.creator_id}
                  className="profile-post__details-username"
                >
              ...
              {post.creator_id === auth.user.user_id ? (
                <button
                  ...
                  name={post.post_id}
                  className="profile-post__delete"
                >
                  &times;
                </button>
              ) : null}
    ...
    return <ul className="profile-posts">{userPosts}</ul>;
  }
}
